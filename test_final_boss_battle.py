...
class Test(TestCase):
    ...
    def test_final_boss_battle_correct_answer(self, mock_output, _):
    ...
    @patch('builtins.input', side_effect=['cloud', 'fire', 'footsteps', 'silence', 'artichoke', 'future'])
    @patch('sys.stdout', new_callable=io.StringIO)
    def test_final_boss_battle_wrong_answer(self, mock_output, _):
